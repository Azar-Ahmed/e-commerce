{{-- <li><img src="{{asset('front_assets/assets/images/payments/5.png')}}" alt=""></li> --}}
              ...
              <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                  <div class="footer-widget mb-40">
                      <div class="footer-logo">
                          <a href="#"><img alt="" src="{{asset('front_assets/assets/images/logo/logo.png')}}"></a>
  ...
  <div class="footer-bottom border-top-2 pt-20 pb-20">
      <div class="container">
          <div class="copyright text-center">
              <p>Copyright <a href="#">Eliza</a> © 2021. All Right Reserved.</p>
          </div>
      </div>
  </div>
</footer>
