      ...
      <div class="container-fluid">
          <div class="row align-items-center">
              <div class="col-xl-2 col-lg-2">
                  <div class="logo">
                      <a href="{{url('/')}}">
                          <img src="{{asset('front_assets/assets/images/logo/logo.png')}}" alt="logo">
                      </a>
                  </div>
              </div>
              <div class="col-xl-8 col-lg-8">
                  <div class="main-menu">
                      <nav>
                          <ul>
                              <li class="angle-shape"><a href="{{url('/')}}">Home </a></li>
                              <li class="angle-shape"><a href="#">Categories </a>
                                <ul class="submenu">
                                  @foreach ($category as $cat)
                                     <li><a href="{{url('shop/'.$cat->cat_slug)}}">{{$cat->cat_name}} </a></li>
                                  @endforeach
                                </ul>
                            </li>
          ...
          <div class="row align-items-center">
              <div class="col-6">
                  <div class="mobile-logo">
                      <a href="index.html">
                          <img alt="" src="{{asset('front_assets/assets/images/logo/logo.png')}}">
                      </a>
                  </div>
              </div>
              <div class="col-6">
  ...
  <div class="header-mobile-aside-wrap">
      <div class="mobile-search">
        <form class="search-form" method="POST" action="{{route('search')}}">
            <input type="text" class="search_input" name="search_input" placeholder="Search entire store…">
          ...
          <div class="mobile-navigation">
              ...
              <nav>
                  <ul class="mobile-menu">
                      ...
                      <li class="menu-item-has-children "><a href="blog.html">Categories</a>
                        <ul class="dropdown">
                          @foreach ($category as $cat)
                          <li><a href="{{$cat->cat_slug}}">{{$cat->cat_name}}</a></li>
                          @endforeach
                        </ul>
                    </li>
    ...
    <div class="sidebar-cart-all">
        ...
        <div class="cart-content">
            ...
            <div class="cart-checkout-btn btn-hover default-btn">
                <a class="btn-size-md btn-bg-black btn-color" href="{{url('cart/468')}}">view cart</a>
